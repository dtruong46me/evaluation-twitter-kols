...
def parse_tweet_from_kafka_message(kafka_df):
    """
    Take a Spark Streaming DataFrame and parse the value column based on the new schema.
...
if __name__=="__main__":
    ...
    df_flight = parse_tweet_from_kafka_message(df_consume_stream)
